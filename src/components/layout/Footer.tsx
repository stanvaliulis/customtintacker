      ...
      <Container className="py-12">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link href="/brewery-signs" className="hover:text-white transition-colors">Brewery Signs</Link></li>
              <li><Link href="/bar-signs" className="hover:text-white transition-colors">Bar & Pub Signs</Link></li>
              <li><Link href="/cannabis-signs" className="hover:text-white transition-colors">Cannabis Signs</Link></li>
              <li><Link href="/restaurant-signs" className="hover:text-white transition-colors">Restaurant Signs</Link></li>
              <li><Link href="/coffee-signs" className="hover:text-white transition-colors">Coffee & Cafe Signs</Link></li>
              <li><Link href="/sports-signs" className="hover:text-white transition-colors">Sports Signs</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="/artwork-templates" className="hover:text-white transition-colors">Artwork Templates</Link></li>
